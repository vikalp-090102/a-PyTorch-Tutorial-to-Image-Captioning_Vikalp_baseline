...
# Suppress torchvision deprecation warning
...
class Encoder(nn.Module):
    ...
    def __init__(self, encoded_image_size=14):
        ...
        modules = list(resnet.children())[:-2]  # Remove final classification layers
...
class Attention(nn.Module):
    ...
    def __init__(self, encoder_dim: int, decoder_dim: int, attention_dim: int):
        ...
        assert isinstance(encoder_dim, int) and isinstance(decoder_dim, int) and isinstance(attention_dim, int), \
            "Attention dimensions must be integers"
...
class DecoderWithAttention(nn.Module):
    ...
    def __init__(self, attention_dim=512, embed_dim=300, decoder_dim=512, encoder_dim=2048, dropout=0.5):
        ...
        assert all(isinstance(val, int) for val in [attention_dim, embed_dim, decoder_dim, encoder_dim]), \
            "DecoderWithAttention dimensions must be integers"
